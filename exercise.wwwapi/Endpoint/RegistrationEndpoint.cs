...
namespace exercise.wwwapi.Endpoint
{
    ...
    {
        public static void ConfigureRegistrationEndpoint(this WebApplication app)
        {
        ...
        private static async Task<IResult> RegisterUser(UserRequestDTO request, IRepository<User> service)
        {
