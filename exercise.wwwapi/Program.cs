...
builder.Services.AddScoped<IRepository<Follows>, Repository<Follows>>();

builder.Services.AddScoped<IRepository<Comment>, Repository<Comment>>();
builder.Services.AddScoped(typeof(ICommentRepo<>),typeof(CommentRepo<>));
...
app.ConfigureRegistrationEndpoint();
app.ConfigureBlogPostEndpoint();
app.ConfigureCommentEndpoint();
app.ConfigureUserFollowEndpoint();
